...
public class AutoChooser extends SendableChooser<Auto> {
    ...
    private static final List<AutoProgram> AUTO_PROGRAMS = List.of(
            ...
            new AutoProgram(Auto.MARK_PICKUP_TEST, "Mark Pickup test", AutoFactory::createMarkTestAuto),
            new AutoProgram(Auto.KLA, "3x Far left, KLA", AutoFactory::createKLAAuto),
            new AutoProgram(Auto.DCB, "3x Far right, DCB", AutoFactory::createDCBAuto),
            new AutoProgram(Auto.ABBA, "4x Far left, ABBA", AutoFactory::createABBAAuto),
            new AutoProgram(Auto.BABA, "4x Far right, BABA", AutoFactory::createBABAAuto),
            new AutoProgram(Auto.IKLJ, "4x Left, IKLJ", AutoFactory::createIKLJAuto),
            new AutoProgram(Auto.FDCE, "4x Right, FDCE", AutoFactory::createFDCEAuto),
            new AutoProgram(Auto.JKLAB, "5x Left, JKLAB", AutoFactory::createJKLABAuto),
            new AutoProgram(Auto.EDCBA, "5x Left, EDCBA", AutoFactory::createEDCBAAuto));
